...
\textbf{\underline{Question 1.3} Explore the effect of different wave controller parameters on the performance metrics of the robot locomotion in \fileref{cmc\_controllers/exercise\_1.2.py}. Simulate the robot swimming and perform a 2D-grid parameter investigation of \underline{$A \in [1.0,4.0]$,} \\ \underline{$TWL \in [0.2,1.5]$   and $f =1.5 Hz$}. Qualitatively analyze the effect on the forward speed, CoT, and average $IPL_{neur}$.
}
...
\begin{figure}[H]
  \centering \includegraphics[width=.8\textwidth]{figures/network swimming.png}
...
\begin{figure}[H]
  \centering \includegraphics[width=.95\textwidth]{figures/drive.png}
...
$PB \in [\frac{\pi}{2n_{joint}}, \frac{3\pi}{n_{joint}}]\,\mathrm{rad}$,
...
\begin{figure}[H]
  \centering \includegraphics[width=.5\textwidth]{figures/imitation.png}
