...
To study the robustness and redundancy of ipsilateral coupling in the CPG network, we carry out an ablation study with two controller configurations (Tab.~\ref{tab:disruption}) and five disruption probabilities equally distributed between $0\%$ and $20\%$ (Tab.~\ref{tab:disruption_config}).
...
\begin{tabular}{|l|l|l|}
    ...
    \hline
    Muted Sensors & $[0,10\%]$ & $0$ \\
    \hline
    Removed Couplings & $0$ & $[0,10\%]$ \\
    \hline
    Mixed & \multicolumn{2}{c|}{$[0,10\%]$} \\
    \hline
\end{tabular}
